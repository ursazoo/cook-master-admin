  ...
  return (
    <div className={styles['search-form-wrapper']}>
      ...
      >
        <Row gutter={24}>
          <Col span={8}>
            <Form.Item label="基础食材" field="name">
              <Input allowClear placeholder="请输入基础食材名称" />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item label="二级食材" field="ingredientSubTypeId">
              <Select showSearch allowClear placeholder="选择所属分类">
                {props?.ingredientSubTypes.map((options, index) => {
                  return (
      ...
      <div className={styles['right-button']}>
        <Button style={{marginRight: '10px'}} type="primary" icon={<IconSearch />} onClick={handleSubmit}>
          搜索
        </Button>
